...
class LRSchedulerStep(object):
    def __init__(self, fai_optimizer: OptimWrapper, total_step, last_step, lr_phases,
                 mom_phases):
...
class OneCycle(LRSchedulerStep):
    def __init__(self, fai_optimizer, total_step, last_step, lr_max, moms, div_factor,
                 pct_start):
        self.lr_max = lr_max
        self.moms = moms
        ...
        super().__init__(fai_optimizer, total_step, last_step, lr_phases, mom_phases)
