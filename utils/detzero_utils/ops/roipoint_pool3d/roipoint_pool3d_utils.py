...
from detzero_utils.ops.roipoint_pool3d import roipoint_pool3d_cuda
...
class RoIPointPool3dFunction(Function):
    ...
    def forward(ctx, points, point_features, boxes3d, pool_extra_width, num_sampled_points=512):
        ...
        pooled_boxes3d = box_utils.enlarge_box3d(boxes3d.reshape(-1, 7), pool_extra_width).reshape(batch_size, -1, 7)
