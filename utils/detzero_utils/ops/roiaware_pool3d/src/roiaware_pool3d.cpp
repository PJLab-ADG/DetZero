...
int points_in_boxes_gpu_v2(at::Tensor boxes_tensor, at::Tensor pts_tensor, at::Tensor box_idx_of_points_tensor){
    // params boxes: (B, N, 7) [x, y, z, dx, dy, dz, heading] (x, y, z) is the box center
    // params pts: (B, npoints, 3) [x, y, z]
...
//    CHECK_INPUT(box_idx_of_points_tensor);
    ...
    points_in_boxes_v2_launcher(batch_size, boxes_num, pts_num, boxes, pts, box_idx_of_points);
...
int points_in_boxes_num_gpu(at::Tensor boxes_tensor, at::Tensor pts_tensor, at::Tensor points_in_box_num_tensor){
    // params boxes: (B, N, 7) [x, y, z, dx, dy, dz, heading] (x, y, z) is the box center
    // params pts: (B, npoints, 3) [x, y, z]
    // params points_in_box_num: (B, N), default 0

//    CHECK_INPUT(boxes_tensor);
//    CHECK_INPUT(pts_tensor);
//    CHECK_INPUT(points_in_box_num);
    ...
    const float *boxes = boxes_tensor.data<float>();
    const float *pts = pts_tensor.data<float>();
    int *points_in_box_num = points_in_box_num_tensor.data<int>();

    points_in_boxes_num_launcher(batch_size, boxes_num, pts_num, boxes, pts, points_in_box_num);

    return 1;
}

int points_in_boxes_2d_gpu(at::Tensor boxes_tensor, at::Tensor pts_tensor, at::Tensor box_idx_of_points_tensor){
    // params boxes: (B, N, 5) [x, y, dx, dy, heading] (x, y) is the box center
...
//    CHECK_INPUT(box_idx_of_points_tensor);
    ...
    points_in_boxes_2dlauncher(batch_size, boxes_num, pts_num, boxes, pts, box_idx_of_points);

    return 1;
}


int points_in_boxes_2d_gpu_v2(at::Tensor boxes_tensor, at::Tensor pts_tensor, at::Tensor pts_indices_tensor){
    // params boxes: (B, N, 5) [x, y, dx, dy, heading] (x, y) is the box center
    // params pts: (B, npoints, 2) [x, y]
...
//    CHECK_INPUT(pts_indices);
    ...
    points_in_boxes_2dlauncher_v2(batch_size, boxes_num, pts_num, boxes, pts, pts_indices);
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    m.def("points_in_boxes_gpu_v2", &points_in_boxes_gpu_v2, "points_in_boxes_gpu V2 forward (CUDA)");
    m.def("points_in_multi_boxes_gpu", &points_in_multi_boxes_gpu, "points_in_multi_boxes_gpu forward (CUDA)");
    m.def("points_in_boxes_num_gpu", &points_in_boxes_num_gpu, "points_in_boxes_num_gpu forward (CUDA)");
    m.def("points_in_boxes_2d_gpu", &points_in_boxes_2d_gpu, "points_in_boxes_2d_gpu forward (CUDA)");
    m.def("points_in_boxes_2d_gpu_v2", &points_in_boxes_2d_gpu_v2, "points_in_boxes_2d_gpu v2 forward (CUDA)");
