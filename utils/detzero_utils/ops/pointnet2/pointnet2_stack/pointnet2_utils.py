...
from detzero_utils.ops.pointnet2.pointnet2_stack import pointnet2_stack_cuda as pointnet2
from detzero_utils import kde_utils
...
class QueryAndGroup(nn.Module):
    def __init__(self, radius: float, nsample: int, use_xyz: bool = True, use_density: bool = False):
        ...
        """
        super().__init__()
        self.radius, self.nsample, self.use_xyz, self.use_density = radius, nsample, use_xyz, use_density
